  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.primaryColor,
        elevation: 0,
        title: Text("Result".tr, // Localized title
                        ...
                        BarChartGroupData(
                          ...
                          barRods: [
                            BarChartRodData(
                              toY: 2270.41 +
                                  (24000 - 2270.41) +
                                  10000, // Total height of the bar
                              color: Colors.blue, // Color for the entire bar
                              width: 30, // Width of the bar
                              borderRadius: BorderRadius
                                  .zero, // Sharp corners for a rectangle
                            ),
                          ],
                          showingTooltipIndicators: [
                            0
                          ], // Show tooltip for the combined bar
                        ),
                      ],
                    ),
                  ),
