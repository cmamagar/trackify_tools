      ...
      children: [
        Container(
          ...
          child: Table(
            ...
            columnWidths: {
              0: FlexColumnWidth(0.8), // S.N
              1: FlexColumnWidth(1), // H.S Code
              2: FlexColumnWidth(2.2), // Particulars
              3: FlexColumnWidth(1), // Qty.
              4: FlexColumnWidth(1), // Rate
              5: FlexColumnWidth(2), // Amount (spanning two sub-columns)
            },
            children: [
              TableRow(
                children: [
        ...
        Container(
          ...
          child: Table(
            ...
            columnWidths: {
              0: FlexColumnWidth(6), // S.N
              1: FlexColumnWidth(3), // H.S Code
              2: FlexColumnWidth(3), // Particulars
            },
            children: [
              TableRow(children: [
                Text(""),
